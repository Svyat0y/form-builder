...
export const TextareaFieldIcon: FC = () => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 24 24"
...
export const RadioFieldIcon: FC = () => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 24 24"
...
export const CheckboxFieldIcon: FC = () => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 24 24"
...
export const SelectFieldIcon: FC = () => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 24 24"
...
export const RatingFieldIcon: FC = () => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 24 24"
...
export const ScaleFieldIcon: FC = () => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 24 24"
...
export const FIELD_ICONS: Record<string, FC> = {
  text: TextFieldIcon,
  textarea: TextareaFieldIcon,
  radio: RadioFieldIcon,
  checkbox: CheckboxFieldIcon,
  select: SelectFieldIcon,
  rating: RatingFieldIcon,
  scale: ScaleFieldIcon,
  date: DateFieldIcon,
  file: FileFieldIcon,
}
